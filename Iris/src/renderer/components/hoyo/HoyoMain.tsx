            ...
            try {
                ...
                if (window.settings.get("hoyolab.cookie") && window.settings.get("hoyolab.uid")) {
                    ...
                    try {
                        ...
                        console.warn("Cookie login failed, falling back to username/password:", cookieError);
                        // Clear invalid cookies and fall back to login
                        window.settings.set("hoyolab.cookie", "");
                        window.settings.set("hoyolab.uid", "");
                        // Then proceed with username/password login
                    }
                }
